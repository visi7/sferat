...
- **Kontroll para-lançimi (siguri, ligj, SEO)** — kalim i gjerë, disa gjetje:
  ...
  - **Privacy Policy dhe Terms of Use (draft fillestar)** — faqe të reja `/privacy` dhe `/terms`, të lidhura te footer-i dhe si kuti pranimi e detyrueshme te `/sign-up` (butoni "Create account" mbetet i çaktivizuar derisa të pranohen). **Shënim i rëndësishëm: janë draft, jo dokumente të rishikuara ligjërisht** — email-i i kontaktit është ende placeholder `[CONTACT EMAIL — to be added]`, duhet plotësuar; për një platformë me audiencë globale (BE/GDPR), rekomandohet rishikim nga dikush me njohuri ligjore përpara se të konsiderohen "final".
